...
UPDATE RAW.SEED.ports SET max_power_kw = 50  WHERE charge_point_id = 'CH-001' AND port_id = '2';
...
UPDATE RAW.SEED.connectors SET max_power_kw = 150 WHERE charge_point_id = 'CH-001' AND port_id = '1';
UPDATE RAW.SEED.connectors SET max_power_kw = 50  WHERE charge_point_id = 'CH-001' AND port_id = '2';
UPDATE RAW.SEED.connectors SET max_power_kw = 350 WHERE charge_point_id = 'CH-002' AND port_id = '1';
UPDATE RAW.SEED.connectors SET max_power_kw = 150 WHERE charge_point_id = 'CH-002' AND port_id = '2';
